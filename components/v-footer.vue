  ...
  <div class="col-12 mt-5 mb-4">
    <div class="row">
      <div class="col-12 col-md-6 mt-3">
        ...
        <p class="mt-2 mb-0">微博 · <a
            href="https://weibo.com/ljrgc"
            target="_blank"
          >@LJR交通美学研究所</a></p>
        <p class="mt-2">联系 / 内容维护 / 反馈请至 <code>LJRstudio@aliyun.com</code></p>
        <small class="subtext">
          <nuxt-link to="/about/help">帮助</nuxt-link> · <nuxt-link to="/about/agreement">使用协议与版权信息</nuxt-link> · <nuxt-link to="/about/privacy">隐私政策</nuxt-link> · <nuxt-link to="/about/update">更新日志</nuxt-link>
        </small>
      </div>
